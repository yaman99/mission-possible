...
} from '@features/career-center/announcements/announcements-list/announcements-list.component';

import {
  AddAnnouncementComponent
} from '@features/career-center/announcements/add-announcement/add-announcement.component';
